...
import type { DBCategory, UICategory, ProcessedDBCategory } from "@/app/_types/db"
...
export const getAllCategories = async ():Promise<ProcessedDBCategory[]> => {
...
export const getCategoryById = async (id:number):Promise<ProcessedDBCategory> => {
