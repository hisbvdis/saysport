...
import type { DBObject, UIObject, ProcessedDBObject } from "@/app/_types/db";
import { and, between, count, desc, eq, exists, gte, ilike, inArray, isNull, lte, ne, notExists, or, Placeholder, sql } from "drizzle-orm";
...
export const getObjectById = async (id:number):Promise<ProcessedDBObject> => {
