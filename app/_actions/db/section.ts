...
import type { DBSection, UISection, ProcessedDBSection } from "@/app/_types/db";
...
export const getAllSections = async ():Promise<ProcessedDBSection[]> => {
...
export const getSectionsByFilters = async (filters:{objectType?:objectTypeUnion;sectionType?:sectionTypeUnion;name_service?:string;name_public_plural?:string}):Promise<ProcessedDBSection[]> => {
...
export const getSectionById = async (id:number):Promise<ProcessedDBSection> => {
